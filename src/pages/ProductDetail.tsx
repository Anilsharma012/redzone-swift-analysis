...
const allProducts = [
  {
    ...
    supplementFacts: { servingSize: '1 vial', servingsPerContainer: 1, nutrients: [{ name: 'BPC-157 Peptide', amount: '5mg', dv: '*' }, { name: 'Purity', amount: '99%+', dv: '' }] },
  ...
  },
  {
    ...
    description: 'Testosterone Cypionate is a long-acting ester of testosterone, commonly used for testosterone replacement therapy.',
    ...
    supplementFacts: { servingSize: '1ml', servingsPerContainer: 10, nutrients: [{ name: 'Testosterone Cypionate', amount: '250mg', dv: '*' }, { name: 'Carrier Oil', amount: 'GSO', dv: '' }] },
  ...
  },
  {
    ...
    usage: 'Reconstitute with bacteriostatic water. Consult with a healthcare professional for proper dosing protocol.',
    supplementFacts: { servingSize: '1 vial', servingsPerContainer: 1, nutrients: [{ name: 'Semaglutide', amount: '5mg', dv: '*' }, { name: 'Purity', amount: '99%+', dv: '' }] },
  ...
  },
  {
    ...
    description: 'Tamoxifen is a selective estrogen receptor modulator (SERM) commonly used in post cycle therapy.',
    ...
    supplementFacts: { servingSize: '1 tablet', servingsPerContainer: 30, nutrients: [{ name: 'Tamoxifen Citrate', amount: '20mg', dv: '*' }] },
    ingredients: 'Tamoxifen Citrate, Microcrystalline Cellulose, Magnesium Stearate',
  },
  { id: '5', name: 'TB-500 Peptide', category: 'Peptide', image: proteinImg, servings: '5mg/vial', goal: 'Recovery', highlight: 'Tissue Repair', tagline: 'Regenerative peptide for tissue repair', description: 'TB-500 is a synthetic version of the naturally occurring peptide Thymosin Beta-4.', benefits: ['Promotes tissue regeneration', 'Supports flexibility', 'Enhances recovery', 'Reduces inflammation'], usage: 'Reconstitute with bacteriostatic water.', supplementFacts: { servingSize: '1 vial', servingsPerContainer: 1, nutrients: [{ name: 'TB-500', amount: '5mg', dv: '*' }] }, ingredients: 'TB-500 Peptide (Lyophilized)' },
  { id: '6', name: 'Testosterone Enanthate', category: 'Injectable', image: creatineImg, servings: '250mg/ml', goal: 'Performance', highlight: 'Long Ester', tagline: 'Long-acting testosterone ester', description: 'Testosterone Enanthate is a long-acting testosterone ester.', benefits: ['Long-acting formula', 'Stable hormone levels', 'Supports muscle growth', 'Less frequent dosing'], usage: 'For intramuscular use only.', supplementFacts: { servingSize: '1ml', servingsPerContainer: 10, nutrients: [{ name: 'Testosterone Enanthate', amount: '250mg', dv: '*' }] }, ingredients: 'Testosterone Enanthate, MCT Oil, Benzyl Alcohol' },
  { id: '7', name: 'Tirzepatide', category: 'Fat Loss', image: preworkoutImg, servings: '10mg/vial', goal: 'Weight Loss', highlight: 'GIP/GLP-1', tagline: 'Dual-action weight management peptide', description: 'Tirzepatide is a dual GIP and GLP-1 receptor agonist.', benefits: ['Dual mechanism action', 'Superior appetite control', 'Regulates metabolism', 'Clinically proven'], usage: 'Reconstitute with bacteriostatic water.', supplementFacts: { servingSize: '1 vial', servingsPerContainer: 1, nutrients: [{ name: 'Tirzepatide', amount: '10mg', dv: '*' }] }, ingredients: 'Tirzepatide (Lyophilized)' },
  { id: '8', name: 'Clomiphene Citrate', category: 'SERMs', image: vitaminsImg, servings: '50mg/tab', goal: 'PCT', highlight: 'Fertility', tagline: 'SERM for hormone restoration', description: 'Clomiphene is a selective estrogen receptor modulator.', benefits: ['Stimulates LH/FSH', 'Restores natural production', 'Oral administration', 'Well-studied compound'], usage: 'Take orally with water.', supplementFacts: { servingSize: '1 tablet', servingsPerContainer: 30, nutrients: [{ name: 'Clomiphene Citrate', amount: '50mg', dv: '*' }] }, ingredients: 'Clomiphene Citrate, Lactose, Magnesium Stearate' },
];
