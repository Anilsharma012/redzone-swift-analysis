    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative pt-20 min-h-[70vh] flex items-center">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Huge Pharma Athletes" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-foreground-muted leading-relaxed">
              Huge Pharma was born from a simple frustration: too many supplements promise everything and deliver nothing. 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-foreground-muted">
                <p>
                  We don't just make supplements—we fuel ambition. Every product in the Huge Pharma lineup is designed 
                ...
                <p>
                  Join thousands of athletes who trust Huge Pharma to power their journey. Because when you're serious 
